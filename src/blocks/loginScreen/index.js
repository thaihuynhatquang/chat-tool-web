...
export const LoginScreen = () => {
  return (
    <div className='animated fadeIn'>
      ...
      />
      <div id='particles-background' className='vertical-centered-box background-app' />
            ...
            render={(renderProps) => (
              <div>
                <div
                  ...
                  <img src={require('../../shared/logo.svg')} alt='Communication Tool' width='400px' height='400px' />
                </div>
                <Button
                  style={{
                    textAlign: 'center',
                  ...
                  <span style={{ color: '#1F1E1A' }}>Đăng nhập với Google</span>
                </Button>
              </div>
            )}
          />
